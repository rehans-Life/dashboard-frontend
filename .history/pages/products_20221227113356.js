...
const Product = ({
  ...
  return (
    <Card component={"div"} backgroundColor={theme.palette.background.alt}>
      <Box>
        <Typography textTransform="capitalize" color={theme.palette.secondary[500]}>{category}</Typography>
        <Typography fontWeight={"bold"} color={theme.palette.secondary[100]}>
          {name}
        </Typography>
        <Typography color={theme.palette.secondary[300]}>${price}</Typography>
      </Box>
    </Card>
  );
};
