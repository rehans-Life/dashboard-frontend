...
const Product = ({
  ...
  return (
    ...
    >
      ...
      <Box marginY="1rem" display="flex" alignItems="center">
        {[0, 0, 0, 0, 0].map((_, index) =>
          index < rating ? (
            <Star key={index} fontSize="15px" sx={{color: theme.palette.secondary[500]}}/>
          ) : (
            <StarBorderOutlined key={index} fontSize="15px" sx={{color: theme.palette.secondary[500]}}/>
          )
        )}
      </Box>
    </Card>
